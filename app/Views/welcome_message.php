...
<head>
	<meta charset="UTF-8">
	<title>Welcome to EpicureApp</title>
...
<header>
	...
	<div class="menu">
		<ul>
			<li class="logo"><a href="" target="_blank"><img height="44" title="Epicure App Logo"
																					alt="Visit EpicureApp "
																					src=""></a>
			</li>
			...
			<li class="menu-item hidden"><a
					href="" target="_blank">Contribute</a>
			</li>
		</ul>
	</div>
	...
	<div class="heroe">
		...
		<h2>Mobile Application For Cooking Enthusiasts</h2>
...
<section>
	...
	<p>The page you are looking at is being generated dynamically by Epicure App.</p>


	<pre><code>Nothing to show </code></pre>
...
<div class="further">
	...
	<section>
		...
		<p>The User Guide contains an introduction, tutorial, a number of "how to"
			...
			the Epicure App. Check the <a href=""
		...
		<p>Epicure App is a Food lovers app  <a href=""
			 target="_blank">Install Epicure App</a>, or <a href="" target="_blank">chat on Slack</a> !</p>
		...
		<p>Epicure App which helps the food lovers to get install from here
